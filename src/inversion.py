...
from src.red_diffeq import RED_DiffEq
...
class run_inversion:
    ...
    def __init__(self, diffusion_model, data_trans_module, data_vis_module, pytorch_ssim_module, regularization):
        self.diffusion_model = diffusion_model
        self.data_trans = data_trans_module
    ...
    def sample(self, mu, mu_true, y, ts, lr=0.001, reg_lambda=0.01, fwi_forward=None, 
        ...
        # Safety: ensure a forward operator is provided
        ...
        # Apply noise and/or missing traces to seismic data
